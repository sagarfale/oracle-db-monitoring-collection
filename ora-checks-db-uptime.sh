#!/bin/bash
########################################################################################################
# Name          : ora-checks-db-uptime.sh
# Author        : Sagar Fale
# Date          : 29/12/2022
#
# Description:  - This script will check if DB is up and running
#
# Usage         : ora-checks-db-uptime.sh - v1
#
...
tlog=`date "+ora_dbcheck_uptime-log-%d%b%Y_%H%M".log`
...
## in case you want to skip some dbs.. then specify the value for EXC_DB
## replace 

EXC_DB=        ### specify the value here
